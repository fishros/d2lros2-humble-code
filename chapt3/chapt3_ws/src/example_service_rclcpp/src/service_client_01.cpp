...
public:
    ...
    void send_request_(int a, int b)
    {
...
private:
    ...
    void result_callback_(rclcpp::Client<example_interfaces::srv::AddTwoInts>::SharedFuture response)
    {
        auto result = response.get();
        RCLCPP_INFO(this->get_logger(), "计算结果：%ld", result->sum);
    }
